...
import ch.desm.middleware.app.core.component.interlocking.obermattlangnau.maps.OMLMapFahrstrassenSchalter;

//Register = AN, Pin = 0
public class OMLElementWeichenschalterSchalter {

	private static Logger LOGGER = Logger.getLogger(OMLElementWeichenschalterSchalter.class);
	
	private OMLMapFahrstrassenSchalter map;
	
	public OMLElementWeichenschalterSchalter(){
