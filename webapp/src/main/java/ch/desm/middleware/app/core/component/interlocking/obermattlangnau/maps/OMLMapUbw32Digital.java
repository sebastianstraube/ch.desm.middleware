...
public class OMLMapUbw32Digital extends ComponentMapBase {
	...
	protected void initialize() {
		...
		map.put("1.91.21", "A1"); //Fahrtrichtung verlangt von Zollbrück
		...
		map.put("1.91.01", "A15"); //Rückmelden möglich nach Langnau
...
//		map.put("9.99.12", ""); //Gleisisolierung
		...
		map.put("3.04.02", "E2"); //FSS Kuppelstrommagnet !!! TODO revert changed from E5 to E2
