...
// map.put("OML_Lampen_Signal_F_$1_F_gruenFB3",""); //
        map.put("OML_Iso_1_$belegt","logic_iso_1_belegt"); //
...
// map.put("OML_Fstr_fg_$geprueft1",""); //
        map.put("OML_Iso_ef_$belegt","logic_iso_ef_belegt"); //
// map.put("OML_Iso_gf_$belegen",""); //
// map.put("OML_Iso_gf_$belegt",""); //
        map.put("OML_Iso_egf_$belegt","logic_iso_egf_belegt"); //
...
// map.put("OML_BL_OM_LN_$RMM_nLN",""); //
        map.put("OML_Iso_cd_$belegt","logic_iso_cd_belegt"); //
