...
import ch.desm.middleware.communication.endpoint.serial.ubw32.EndpointUbw32;
import ch.desm.middleware.communication.endpoint.tcp.EndpointTcpClient;
...
//		log.trace("java.library.path");
	...
	public static void testCaseUbw32(){
		EndpointUbw32 endpoint = new EndpointUbw32(EnumSerialPorts.COM33, "192,0,8192,16372,0,1,2", "0");
