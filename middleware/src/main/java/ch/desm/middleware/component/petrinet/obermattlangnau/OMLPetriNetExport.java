...
public abstract class OMLPetriNetExport {
	...
	public int Kontakte_7_WS1_plus1;
	...
	public void init() {
		...
		Kontakte_7_WS1_plus1 = 0;
		Kontakte_7_WS1_minus0 = 0;
		Kontakte_7_WS1_minus1 = 0;
	...
	public boolean fireOneTransition() {
		...
		if ((Kontakte_7_WS1_minus0 >= 1) && (W1_Endlage_minus <= 0)
				&& (W1_keine_Endlage >= 1)) {
		...
		if ((Kontakte_7_WS1_plus0 >= 1) && (W1_Endlage_plus <= 0)
				&& (W1_keine_Endlage >= 1)) {
		...
		if ((W1_Endlage_plus >= 1) && (Kontakte_7_WS1_plus0 < 1)
				&& (W1_keine_Endlage <= 0)) {
			if (canFire("W1_T3")) {
				--W1_Endlage_plus;
				++W1_keine_Endlage;
		...
		if ((W1_Endlage_minus >= 1) && (Kontakte_7_WS1_minus0 < 1)
				&& (W1_keine_Endlage <= 0)) {
			if (canFire("W1_T4")) {
				--W1_Endlage_minus;
				++W1_keine_Endlage;
		...
		if ((W1_Endlage_plus >= 1) && (ext_Vb_Ueberw_W1_plus < 1)
				&& (W1_gestoert_p <= 0)) {
			if (canFire("W1_T6")) {
				--W1_Endlage_plus;
				++W1_gestoert_p;
		...
		if ((W1_Endlage_plus <= 0) && (ext_Vb_Ueberw_W1_plus >= 1)
				&& (W1_gestoert_p >= 1)) {
			if (canFire("W1_T7")) {
				++W1_Endlage_plus;
				--ext_Vb_Ueberw_W1_plus;
		...
		if ((W1_Endlage_minus >= 1) && (W1_gestoert_m <= 0)
				&& (ext_Vb_Ueberw_W1_minus < 1)) {
			if (canFire("W1_T8")) {
				--W1_Endlage_minus;
				++W1_gestoert_m;
		...
		if ((W1_gestoert_m >= 1) && (W1_Endlage_minus <= 0)
				&& (ext_Vb_Ueberw_W1_minus >= 1)) {
			if (canFire("W1_T9")) {
				--W1_gestoert_m;
				++W1_Endlage_minus;
		...
		if ((Fstr_ef_aufgeloest >= 1) && (W1_Endlage_plus >= 1)
				&& (Fstr_ef_P6 <= 0) && (Kontakte_8_FSS_30EG >= 1)) {
		...
		if ((Fstr_ef_aufgeloest <= 0) && (Fstr_ef_verschlossen >= 1)
				&& (Kontakte_8_FSS_30EG >= 1) && (Fstr_ef_Zug_eingefahren >= 1)) {
		...
		if ((Fstr_ef_verschlossen >= 1) && (Fstr_ef_E_Fahrt1 <= 0)
				&& (Fstr_ef_E_Halt >= 1) && (Kontakte_8_FSS_90EG >= 1)) {
		...
		if ((Fstr_ef_P2 >= 1) && (Fstr_ef_E_Fahrt1 >= 1)
				&& (Fstr_ef_E_Halt <= 1)) {
		...
		if ((Fstr_ef_P1 <= 0) && (Iso_ef_belegt >= 1)) {
		...
		if ((Fstr_ef_P2 <= 0) && (Iso_1_belegt >= 1) && (Fstr_ef_P1 >= 1)) {
		...
		if ((Fstr_ef_P2 >= 1) && (Fstr_ef_Zug_eingefahren <= 0)) {
		...
		if ((Fstr_ef_verschlossen <= 0) && (Fstr_ef_geprueft2 >= 1)
		...
		if ((Fstr_ef_Stoerung_E >= 1) && (Fstr_ef_E_Fahrt1 >= 1)
				&& (Fstr_ef_E_Halt <= 1)) {
		...
		if ((Fstr_ef_geprueft2 <= 0) && (Kontakte_6_BLU_EG >= 1)
				&& (Fstr_ef_geprueft1 >= 1)) {
		...
		if ((Fstr_ef_geprueft2 <= 0) && (Fstr_ef_geprueft1 >= 1)
				&& (BL_OM_LN_Grundstlg_n >= 1)) {
		...
		if ((Fstr_ef_verschlossen >= 1) && (Kontakte_6_NAL >= 1)
		...
		if ((Fstr_ef_P6 >= 1) && (Fstr_ef_geprueft1 <= 0) && (Iso_1_frei >= 1)
				&& (Iso_egf_frei >= 1) && (Iso_ef_frei >= 1)) {
		...
		if ((Fstr_ef_P6 >= 1) && (Fstr_ef_geprueft1 <= 0)
		...
		if ((Iso_ef_belegt <= 0) && (Iso_ef_frei >= 1)
		...
		if ((Iso_ef_belegt >= 1) && (Iso_ef_Zug_ausfahren >= 1)
				&& (Iso_ef_frei <= 0)) {
		...
		if ((BL_OM_LN_2 <= 0) && (BL_OM_LN_1 >= 1) && (Fstr_fg_F_Halt >= 1)) {
		...
		if ((BL_OM_LN_Grundstlg_n <= 0) && (BL_OM_LN_belegt_n >= 1)
				&& (ILTIS_RM_LN_OM >= 1)) {
		...
		if ((Kontakte_6_FBA_nLN >= 1) && (BL_OM_LN_Grundstlg_n <= 0)
				&& (BL_OM_LN_Grundstlg_v >= 1) && (ILTIS_festgehalten_vLN < 1)) {
		...
		if ((BL_OM_LN_belegt_v >= 1) && (BL_OM_LN_Grundstlg_v <= 0)
				&& (Kontakte_6_RM_nLN >= 1) && (BL_OM_LN_RMM_nLN >= 1)) {
		...
		if ((BL_OM_LN_Grundstlg_v >= 1) && (BL_OM_LN_vorgebl_v <= 0)
				&& (LN_C26_Fahrt >= 1)) {
		...
		if ((BL_OM_LN_vorgebl_n >= 1) && (BL_OM_LN_belegt_n <= 0)
				&& (Fstr_ef_E_Halt >= 1) && (Iso_egf_belegt >= 1)) {
		...
		if ((BL_OM_LN_vorgebl_v >= 1) && (LN_ce_belegt >= 1)
				&& (BL_OM_LN_belegt_v <= 0)) {
		...
		if ((BL_OM_LN_Grundstlg_n >= 1) && (BL_OM_LN_Grundstlg_v <= 0)
				&& (Kontakte_6_FBF_nLN < 1) && (ILTIS_anfordern_vLN >= 1)) {
		...
		if ((BL_OM_LN_1 <= 0) && (Fstr_fg_F_Fahrt3 >= 1)) {
		...
		if ((BL_OM_LN_Grundstlg_n >= 1) && (BL_OM_LN_vorgebl_n <= 0)
		...
		if ((BL_OM_LN_2 >= 1) && (Iso_1_belegt >= 1) && (BL_OM_LN_3 <= 0)) {
		...
		if ((BL_OM_LN_3 >= 1) && (BL_OM_LN_RMM_nLN <= 0) && (Iso_1_frei >= 1)) {
		...
		if ((BL_OM_LN_1 <= 0) && (Fstr_fe_F_Fahrt1 >= 1)) {
		...
		if ((BL_OM_LN_1 >= 1) && (BL_OM_LN_2 <= 0) && (Fstr_fe_F_Halt >= 1)) {
		...
		if ((BL_OM_LN_vorgebl_n >= 1) && (BL_OM_LN_belegt_n <= 0)
				&& (Iso_egf_belegt >= 1) && (Fstr_gf_G_Halt >= 1)) {
		...
		if ((BL_ZB_OM_Grundstlg_v <= 0) && (BL_ZB_OM_Grundstlg_n >= 1)
				&& (Kontakte_6_FBF_nZB < 1) && (ILTIS_anfordern_vZB >= 1)) {
		...
		if ((BL_ZB_OM_vorgebl_n <= 0) && (BL_ZB_OM_Grundstlg_n >= 1)
		...
		if ((BL_ZB_OM_belegt_n >= 1) && (BL_ZB_OM_Grundstlg_n <= 0)
				&& (ILTIS_RM_ZB_OM >= 1)) {
		...
		if ((BL_ZB_OM_belegt_v >= 1) && (BL_ZB_OM_RMM_nZB >= 1)
				&& (BL_ZB_OM_Grundstlg_v <= 0) && (Kontakte_6_RM_nZB >= 1)) {
		...
		if ((BL_ZB_OM_vorgebl_v <= 0) && (BL_ZB_OM_Grundstlg_v >= 1)
				&& (ZB_C_Fahrt >= 1)) {
		...
		if ((BL_ZB_OM_belegt_n <= 0) && (BL_ZB_OM_vorgebl_n >= 1)
				&& (Iso_1_belegt >= 1)) {
		...
		if ((ZB_cd_belegt >= 1) && (BL_ZB_OM_belegt_v <= 0)
		...
		if ((BL_ZB_OM_Grundstlg_v >= 1) && (Kontakte_6_FBA_nZB >= 1)
				&& (BL_ZB_OM_Grundstlg_n <= 0) && (ILTIS_festgehalten_v_ZB < 1)) {
		...
		if ((BL_ZB_OM_1 >= 1) && (BL_ZB_OM_2 <= 0) && (Fstr_gf_G_Halt >= 1)) {
		...
		if ((Fstr_gf_G_Fahrt3 >= 1) && (BL_ZB_OM_1 <= 0)) {
		...
		if ((Iso_1_belegt >= 1) && (BL_ZB_OM_2 >= 1) && (BL_ZB_OM_3 <= 0)) {
		...
		if ((BL_ZB_OM_RMM_nZB <= 0) && (Iso_1_frei >= 1) && (BL_ZB_OM_3 >= 1)) {
		...
		if ((Stw_FSS_Sperrm_ein >= 1) && (Stw_FSS_Sperrm_aus <= 0)
				&& (Kontakte_8_FSS_10F >= 1) && (Stw_P10 >= 1)) {
		...
		if ((Stw_FSS_Kuppelm_aus >= 1) && (Stw_FSS_Kuppelm_ein <= 0)
				&& (Fstr_ef_geprueft2 >= 1)) {
		...
		if ((Stw_FSS_Kuppelm_aus <= 0) && (Stw_FSS_Kuppelm_ein >= 1)
		...
		if ((Kontakte_7_WS1_plus0 >= 1) && (Stw_WS_Sperrm_ein >= 1)
				&& (Stw_WS_Sperrm_aus <= 0)) {
		...
		if ((Kontakte_6_Gleist_EMM >= 1) && (Kontakte_8_FSS_10F >= 1)
				&& (Stw_FSS_Sperrm_ein <= 0) && (Kontakte_7_WS1_plus0 >= 1)
		...
		if ((Stw_FSS_Sperrm_ein >= 1) && (Stw_FSS_Sperrm_aus <= 0)
				&& (Kontakte_8_FSS_10EG >= 1) && (Stw_P11 >= 1)) {
			if (canFire("Stw_T25")) {
				--Stw_FSS_Sperrm_ein;
				++Stw_FSS_Sperrm_aus;
				--Kontakte_8_FSS_10EG;
		...
		if ((Stw_FSS_Kuppelm_ein >= 1) && (Stw_FSS_Kuppelm_aus <= 0)
		...
		if ((Kontakte_8_FSS_10EG >= 1) && (Stw_FSS_Sperrm_ein <= 0)
				&& (Kontakte_6_Gleist_ZB >= 1) && (Kontakte_7_WS1_minus0 >= 1)
				&& (Stw_FSS_Sperrm_aus >= 1)) {
			if (canFire("Stw_T11")) {
				--Kontakte_8_FSS_10EG;
				++Stw_FSS_Sperrm_ein;
		...
		if ((Stw_FSS_Sperrm_aus >= 1) && (Stw_FSS_Sperrm_ein <= 0)
				&& (Kontakte_8_FSS_45EG >= 1)) {
			if (canFire("Stw_T13")) {
				--Stw_FSS_Sperrm_aus;
				++Stw_FSS_Sperrm_ein;
		...
		if ((Stw_WS_Sperrm_ein <= 0) && (Kontakte_6_NT_W1 >= 1)
				&& (Stw_WS_Sperrm_aus >= 1)) {
			if (canFire("Stw_T22")) {
				++Stw_WS_Sperrm_ein;
				--Kontakte_6_NT_W1;
		...
		if ((Kontakte_7_WS1_minus1 >= 1) && (Stw_WS_Sperrm_ein <= 0)
				&& (Stw_WS_Sperrm_aus >= 1) && (Iso_1_frei >= 1)) {
			if (canFire("Stw_T2")) {
				--Kontakte_7_WS1_minus1;
				++Stw_WS_Sperrm_ein;
				--Stw_WS_Sperrm_aus;
		...
		if ((Iso_1_frei >= 1) && (Stw_WS_Sperrm_aus >= 1)
				&& (Stw_WS_Sperrm_ein <= 0) && (Kontakte_7_WS1_plus1 >= 1)) {
		...
		if ((Stw_FSS_Kuppelm_aus >= 1) && (Fstr_fe_geprueft >= 1)
				&& (Stw_FSS_Kuppelm_ein <= 0)) {
			if (canFire("Stw_T5")) {
				--Stw_FSS_Kuppelm_aus;
				--Fstr_fe_geprueft;
		...
		if ((Fstr_gf_geprueft2 >= 1) && (Stw_FSS_Kuppelm_aus >= 1)
				&& (Stw_FSS_Kuppelm_ein <= 0)) {
			if (canFire("Stw_T7")) {
				--Fstr_gf_geprueft2;
				--Stw_FSS_Kuppelm_aus;
		...
		if ((Fstr_fg_Zug_eingefahren >= 1) && (Stw_FSS_Kuppelm_ein >= 1)
				&& (Stw_FSS_Kuppelm_aus <= 0)) {
			if (canFire("Stw_T24")) {
		...
		if ((Stw_WS_Sperrm_ein >= 1) && (Stw_WS_Sperrm_aus <= 0)
		...
		if ((Stw_FSS_Sperrm_aus >= 1) && (Stw_FSS_Sperrm_ein <= 0)
				&& (Kontakte_8_FSS_10F >= 1) && (Kontakte_7_WS1_minus0 >= 1)
		...
		if ((Stw_FSS_Sperrm_aus >= 1) && (Stw_FSS_Sperrm_ein <= 0)
				&& (Kontakte_8_FSS_10EG >= 1) && (Kontakte_7_WS1_plus0 >= 1)
		...
		if ((Kontakte_8_FSS_45F >= 1) && (Stw_P10 <= 0)) {
			if (canFire("Stw_T3")) {
				--Kontakte_8_FSS_45F;
				++Stw_P10;
				fire("Stw_T3");
		...
		if ((Kontakte_8_FSS_45EG >= 1) && (Stw_P11 <= 0)) {
			if (canFire("Stw_T4")) {
				--Kontakte_8_FSS_45EG;
				++Stw_P11;
				fire("Stw_T4");
		...
		if ((Fstr_fe_verschlossen >= 1) && (Fstr_fe_aufgeloest <= 1)
				&& (Fstr_fe_Zug_eingefahren >= 1)) {
		...
		if ((Fstr_fe_P2b >= 1) && (Fstr_fe_Zug_eingefahren <= 0)) {
		...
		if ((Fstr_fe_P1 >= 1) && (Fstr_fe_P2b <= 0) && (Iso_1_belegt >= 1)) {
		...
		if ((Iso_egf_belegt >= 1) && (Fstr_fe_P1 <= 0)) {
		...
		if ((Fstr_fe_F_Fahrt1 >= 1) && (Fstr_fe_F_Halt <= 1)
				&& (Fstr_fe_P2b >= 1)) {
		...
		if ((Fstr_fe_verschlossen >= 1) && (Fstr_fe_F_Halt >= 1)
				&& (Fstr_fe_F_Fahrt1 <= 0) && (Kontakte_8_FSS_90F >= 1)) {
		...
		if ((Fstr_fe_geprueft >= 1) && (Fstr_fe_verschlossen <= 0)
				&& (Kontakte_8_FSS_45F >= 1)) {
		...
		if ((Fstr_fe_aufgeloest >= 1) && (W1_Endlage_plus >= 1)
				&& (Fstr_fe_P2 <= 0) && (Kontakte_8_FSS_30F >= 1)) {
		...
		if ((Fstr_fe_P2 >= 1) && (Iso_ef_frei >= 1) && (Iso_egf_frei >= 1)
				&& (Iso_1_frei >= 1) && (Iso_cd_frei >= 1)
				&& (Fstr_fe_geprueft <= 0)) {
		...
		if ((Fstr_fe_P2 >= 1) && (Fstr_fe_geprueft <= 0)
				&& (Kontakte_6_ISU_Sign >= 1)) {
		...
		if ((Fstr_gf_aufgeloest <= 0) && (Fstr_gf_verschlossen >= 1)
				&& (Fstr_gf_Zug_eingefahren >= 1)) {
		...
		if ((Iso_1_belegt >= 1) && (Fstr_gf_Zug_eingefahren <= 0)) {
		...
		if ((Fstr_gf_Zug_eingefahren >= 1) && (Fstr_gf_G_Fahrt3 >= 1)
				&& (Fstr_gf_G_Halt <= 1)) {
		...
		if ((Fstr_gf_verschlossen >= 1) && (Fstr_gf_G_Fahrt3 <= 0)
				&& (Fstr_gf_G_Halt >= 1) && (Kontakte_8_FSS_90EG >= 1)) {
		...
		if ((Fstr_gf_geprueft2 >= 1) && (Fstr_gf_verschlossen <= 0)
				&& (Kontakte_8_FSS_45EG >= 1)) {
		...
		if ((Fstr_gf_aufgeloest >= 1) && (Fstr_gf_P4 <= 0)
				&& (W1_Endlage_minus >= 1) && (Kontakte_8_FSS_30EG >= 1)) {
		...
		if ((Fstr_gf_Stoerung_G >= 1) && (Fstr_gf_G_Fahrt3 >= 1)
				&& (Fstr_gf_G_Halt <= 1)) {
		...
		if ((Fstr_gf_geprueft1 >= 1) && (Fstr_gf_geprueft2 <= 0)
				&& (BL_ZB_OM_Grundstlg_n >= 1)) {
		...
		if ((Fstr_gf_P4 >= 1) && (Fstr_gf_geprueft1 <= 0)
				&& (Iso_egf_frei >= 1) && (Iso_1_frei >= 1)) {
		...
		if ((Fstr_fg_aufgeloest <= 0) && (Fstr_fg_verschlossen >= 1)
		...
		if ((Fstr_fg_P2 >= 1) && (Fstr_fg_Zug_eingefahren <= 0)) {
		...
		if ((Fstr_fg_P1 >= 1) && (Fstr_fg_P2 <= 0) && (Iso_1_belegt >= 1)) {
		...
		if ((Iso_egf_belegt >= 1) && (Fstr_fg_P1 <= 0)) {
		...
		if ((Fstr_fg_P2 >= 1) && (Fstr_fg_F_Fahrt3 >= 1)
				&& (Fstr_fg_F_Halt <= 1)) {
		...
		if ((Fstr_fg_verschlossen >= 1) && (Fstr_fg_F_Fahrt3 <= 0)
				&& (Fstr_fg_F_Halt >= 1) && (Kontakte_8_FSS_90F >= 1)) {
		...
		if ((Fstr_fg_geprueft2 >= 1) && (Fstr_fg_verschlossen <= 0)
				&& (Kontakte_8_FSS_45F >= 1)) {
		...
		if ((Fstr_fg_aufgeloest >= 1) && (Kontakte_8_FSS_30F >= 1)
				&& (W1_Endlage_minus >= 1) && (Fstr_fg_geprueft0 <= 0)) {
		...
		if ((Fstr_fg_F_Fahrt3 >= 1) && (Fstr_fg_Stoerung_F >= 1)
				&& (Fstr_fg_F_Halt <= 1)) {
		...
		if ((Fstr_fg_geprueft1 >= 1) && (Fstr_fg_geprueft2 <= 0)
				&& (BL_ZB_OM_Grundstlg_n >= 1)) {
		...
		if ((Fstr_fg_verschlossen >= 1) && (Fstr_fg_aufgeloest <= 0)
				&& (Kontakte_6_NAL >= 1)) {
		...
		if ((Fstr_fg_geprueft0 >= 1) && (Fstr_fg_geprueft1 <= 0)
				&& (Iso_1_frei >= 1) && (Iso_egf_frei >= 1)) {
		...
		if ((Iso_1_belegt <= 0) && (Iso_1_Zug_einfahren >= 1)
				&& (Iso_1_frei >= 1)) {
		...
		if ((Iso_1_belegt >= 1) && (Iso_1_frei <= 0)
		...
		if ((Iso_gf_Zug_einfahren >= 1) && (Iso_gf_frei >= 1)
				&& (Iso_gf_belegt <= 0)) {
		...
		if ((Iso_gf_frei <= 0) && (Iso_gf_Zug_ausfahren >= 1)
				&& (Iso_gf_belegt >= 1)) {
		...
		if ((Iso_egf_frei >= 1) && (Iso_egf_Zug_einfahren >= 1)
				&& (Iso_egf_belegt <= 0)) {
		...
		if ((Iso_egf_frei <= 0) && (Iso_egf_belegt >= 1)
		...
		if ((Iso_cd_Zug_einfahren >= 1) && (Iso_cd_belegt <= 0)
				&& (Iso_cd_frei >= 1)) {
		...
		if ((Iso_cd_belegt >= 1) && (Iso_cd_Zug_ausfahren >= 1)
				&& (Iso_cd_frei <= 0)) {
		...
		if ((ext_Vb_F_VS_Lampe_Warn_def >= 1) && (Lampen_1_F_VS_Stoer <= 0)) {
		...
		if ((ext_Vb_F_VS_Lampe_Fahrt_def >= 1) && (Lampen_1_F_VS_Stoer <= 0)) {
		...
		if ((ext_Vb_G_VS_Lampe_Warn_def >= 1) && (Lampen_1_G_VS_Stoer <= 0)) {
		...
		if ((Lampen_1_G_VS_Stoer <= 0) && (ext_Vb_G_VS_Lampe_Fahrt_def >= 1)) {
		...
		if ((Lampen_1_FBV_vLN <= 0) && (ILTIS_anfordern_vLN >= 1)
				&& (Lampen_P34 >= 1)) {
		...
		if ((Lampen_P41 >= 1) && (Lampen_1_Stoer_Wecker <= 0)) {
		...
		if ((Lampen_2_Weiche <= 0) && (Lampen_P1 >= 1)
				&& (W1_Endlage_minus < 1) && (W1_Endlage_plus < 1)) {
		...
		if ((Lampen_2_Block <= 0) && (Lampen_P48 >= 1) && (Lampen_P39 >= 1)
				&& (Lampen_P40 >= 1)) {
		...
		if ((ILTIS_anfordern_vZB >= 1) && (Lampen_1_FBV_vZB <= 0)
				&& (Lampen_P33 >= 1)) {
		...
		if ((Lampen_1_FBV_vZB >= 1) && (Lampen_P33 <= 0)
		...
		if ((Lampen_1_FBV_vLN >= 1) && (BL_OM_LN_Grundstlg_v >= 1)
				&& (Lampen_P34 <= 0)) {
		...
		if ((BL_OM_LN_vorgebl_v >= 1) && (Lampen_1_BL_vLN_rot <= 0)
				&& (Lampen_P4 >= 1)) {
		...
		if ((Lampen_1_BL_vLN_rot >= 1) && (BL_OM_LN_Grundstlg_v >= 1)
				&& (Lampen_P4 <= 0)) {
		...
		if ((Lampen_P6 >= 1) && (Fstr_ef_verschlossen >= 1)
				&& (Lampen_1_Fstr_ef <= 0)) {
		...
		if ((Lampen_1_Fstr_ef >= 1) && (Lampen_P6 <= 0)
				&& (Fstr_ef_aufgeloest >= 1)) {
		...
		if ((Fstr_gf_verschlossen >= 1) && (Lampen_P8 >= 1)
				&& (Lampen_1_Fstr_gf <= 0)) {
		...
		if ((Lampen_P8 <= 0) && (Fstr_gf_aufgeloest >= 1)
				&& (Lampen_1_Fstr_gf >= 1)) {
		...
		if ((Fstr_fg_aufgeloest >= 1) && (Lampen_P8 <= 0)
				&& (Lampen_1_Fstr_gf >= 1)) {
		...
		if ((Lampen_1_Fstr_ef >= 1) && (Fstr_fe_aufgeloest >= 1)
				&& (Lampen_P6 <= 0)) {
		...
		if ((Lampen_1_WS1_Ueberw <= 0) && (Lampen_P112 >= 1)
				&& (W1_Endlage_plus >= 1)) {
		...
		if ((Lampen_1_WS1_Ueberw >= 1) && (Lampen_P112 <= 0)
				&& (W1_Endlage_plus < 1) && (W1_Endlage_minus < 1)) {
		...
		if ((Lampen_1_WS1_Freig <= 0) && (Lampen_P15 >= 1)
				&& (Stw_WS_Sperrm_ein >= 1)) {
		...
		if ((Lampen_1_WS1_Freig >= 1) && (Stw_WS_Sperrm_aus >= 1)
				&& (Lampen_P15 <= 0)) {
		...
		if ((Lampen_1_Fstr_ef <= 0) && (Lampen_P6 >= 1)
		...
		if ((Lampen_P8 >= 1) && (Fstr_fg_verschlossen >= 1)
				&& (Lampen_1_Fstr_gf <= 0)) {
		...
		if ((Lampen_P112 >= 1) && (W1_Endlage_minus >= 1)
				&& (Lampen_1_WS1_Ueberw <= 0)) {
		...
		if ((BL_OM_LN_belegt_v >= 1) && (Lampen_1_BL_vLN_rot <= 0)
				&& (Lampen_P4 >= 1)) {
		...
		if ((Lampen_1_BL_nLN_rot >= 1) && (BL_OM_LN_Grundstlg_n >= 1)
				&& (Lampen_P16 <= 0)) {
		...
		if ((BL_OM_LN_vorgebl_n >= 1) && (Lampen_1_BL_nLN_rot <= 0)
				&& (Lampen_P16 >= 1)) {
		...
		if ((Lampen_P16 >= 1) && (BL_OM_LN_belegt_n >= 1)
				&& (Lampen_1_BL_nLN_rot <= 0)) {
		...
		if ((Lampen_P17 <= 0) && (Fstr_fe_F_Fahrt1 >= 1)
				&& (Lampen_1_F_rot >= 1)) {
		...
		if ((Lampen_P17 >= 1) && (Lampen_1_F_rot <= 0) && (Fstr_fe_F_Halt >= 1)) {
		...
		if ((Lampen_P17 >= 1) && (Lampen_1_F_rot <= 0) && (Fstr_fg_F_Halt >= 1)) {
		...
		if ((Lampen_P17 <= 0) && (Lampen_1_F_rot >= 1)
				&& (Fstr_fg_F_Fahrt3 >= 1)) {
		...
		if ((Fstr_fe_F_Halt >= 1) && (Lampen_1_F_gruenFB1 >= 1)
				&& (Lampen_P20 <= 0)) {
		...
		if ((Fstr_fe_F_Fahrt1 >= 1) && (Lampen_1_F_gruenFB1 <= 0)
				&& (Lampen_P20 >= 1)) {
		...
		if ((Lampen_1_F_gruenFB1 >= 1) && (Fstr_fg_F_Halt >= 1)
				&& (Lampen_P20 <= 0)) {
		...
		if ((Fstr_fg_F_Fahrt3 >= 1) && (Lampen_1_F_gruenFB1 <= 0)
				&& (Lampen_P20 >= 1)) {
		...
		if ((Lampen_1_BL_nLN_weiss >= 1) && (Lampen_P23 <= 0)
				&& (BL_OM_LN_Grundstlg_n < 1) && (BL_OM_LN_vorgebl_n < 1)) {
		...
		if ((Lampen_1_BL_nLN_weiss <= 0) && (BL_OM_LN_Grundstlg_n >= 1)
				&& (Lampen_P23 >= 1)) {
		...
		if ((Lampen_1_BL_nLN_weiss <= 0) && (BL_OM_LN_vorgebl_n >= 1)
				&& (Lampen_P23 >= 1)) {
		...
		if ((Lampen_1_BL_vLN_weiss >= 1) && (Lampen_P26 <= 0)
		...
		if ((BL_OM_LN_Grundstlg_v >= 1) && (Lampen_1_BL_vLN_weiss <= 0)
				&& (Lampen_P26 >= 1)) {
		...
		if ((Lampen_P26 >= 1) && (BL_OM_LN_vorgebl_v >= 1)
				&& (Lampen_1_BL_vLN_weiss <= 0)) {
		...
		if ((Lampen_1_BL_vZB_rot >= 1) && (Lampen_P30 <= 0)
				&& (BL_ZB_OM_Grundstlg_v >= 1)) {
		...
		if ((Lampen_1_BL_vZB_rot <= 0) && (Lampen_P30 >= 1)
				&& (BL_ZB_OM_vorgebl_v >= 1)) {
		...
		if ((Lampen_P30 >= 1) && (BL_ZB_OM_belegt_v >= 1)
				&& (Lampen_1_BL_vZB_rot <= 0)) {
		...
		if ((Lampen_P32 <= 0) && (Lampen_1_BL_vZB_weiss >= 1)
				&& (BL_ZB_OM_vorgebl_v < 1)) {
		...
		if ((BL_ZB_OM_Grundstlg_v >= 1) && (Lampen_P32 >= 1)
				&& (Lampen_1_BL_vZB_weiss <= 0)) {
		...
		if ((Lampen_1_BL_vZB_weiss >= 1) && (BL_ZB_OM_Grundstlg_v < 1)
				&& (Lampen_P32 <= 0)) {
		...
		if ((BL_ZB_OM_vorgebl_v >= 1) && (Lampen_P32 >= 1)
				&& (Lampen_1_BL_vZB_weiss <= 0)) {
		...
		if ((Lampen_1_BL_nZB_rot >= 1) && (Lampen_P35 <= 0)
				&& (BL_ZB_OM_Grundstlg_n >= 1)) {
		...
		if ((Lampen_1_BL_nZB_rot <= 0) && (Lampen_P35 >= 1)
				&& (BL_ZB_OM_belegt_n >= 1)) {
		...
		if ((BL_ZB_OM_vorgebl_n >= 1) && (Lampen_P35 >= 1)
				&& (Lampen_1_BL_nZB_rot <= 0)) {
		...
		if ((Lampen_1_BL_nZB_weiss >= 1) && (Lampen_P38 <= 0)
				&& (BL_ZB_OM_vorgebl_n < 1) && (BL_ZB_OM_Grundstlg_n < 1)) {
		...
		if ((BL_ZB_OM_Grundstlg_n >= 1) && (Lampen_1_BL_nZB_weiss <= 0)
				&& (Lampen_P38 >= 1)) {
		...
		if ((Lampen_1_BL_nZB_weiss <= 0) && (BL_ZB_OM_vorgebl_n >= 1)
				&& (Lampen_P38 >= 1)) {
		...
		if ((Lampen_2_Weiche >= 1) && (W1_Endlage_minus >= 1)
				&& (Lampen_P1 <= 0)) {
		...
		if ((Lampen_2_Weiche >= 1) && (W1_Endlage_plus >= 1)
				&& (Lampen_P1 <= 0)) {
		...
		if ((Lampen_2_Signal <= 0) && (Lampen_P49 >= 1) && (Lampen_P12 >= 1)) {
		...
		if ((Lampen_P49 >= 1) && (Lampen_2_Signal <= 0) && (Lampen_P117 >= 1)) {
		...
		if ((Lampen_P49 >= 1) && (Lampen_2_Signal <= 0) && (Lampen_P21 >= 1)) {
		...
		if ((Lampen_2_Signal >= 1) && (Lampen_P49 <= 0) && (Lampen_P12 < 1)
				&& (Lampen_P117 < 1) && (Lampen_P21 < 1)) {
		...
		if ((Lampen_P12 >= 1) && (Lampen_P13 <= 0) && (Fstr_ef_E_Halt >= 1)) {
		...
		if ((Lampen_P13 >= 1) && (Lampen_P12 <= 0) && (Fstr_ef_E_Fahrt1 < 1)
				&& (Fstr_ef_E_Halt < 1)) {
		...
		if ((Lampen_P12 >= 1) && (Lampen_P13 <= 0) && (Fstr_ef_E_Fahrt1 >= 1)) {
		...
		if ((Lampen_P117 >= 1) && (Fstr_gf_G_Halt >= 1) && (Lampen_P18 <= 0)) {
		...
		if ((Fstr_gf_G_Fahrt3 < 1) && (Fstr_gf_G_Halt < 1)
				&& (Lampen_P117 <= 0) && (Lampen_P18 >= 1)) {
		...
		if ((Lampen_P117 >= 1) && (Fstr_gf_G_Fahrt3 >= 1) && (Lampen_P18 <= 0)) {
		...
		if ((Lampen_P21 >= 1) && (Fstr_fe_F_Halt >= 1) && (Lampen_P22 <= 0)) {
		...
		if ((Fstr_fg_F_Fahrt3 < 1) && (Fstr_fe_F_Fahrt1 < 1)
				&& (Lampen_P21 <= 0) && (Fstr_fe_F_Halt < 1)
				&& (Lampen_P22 >= 1)) {
		...
		if ((Fstr_fe_F_Fahrt1 >= 1) && (Lampen_P21 >= 1) && (Lampen_P22 <= 0)) {
		...
		if ((Lampen_P21 >= 1) && (Lampen_P22 <= 0) && (Fstr_fg_F_Fahrt3 >= 1)) {
		...
		if ((Lampen_2_Block >= 1) && (Lampen_P48 <= 0) && (Lampen_P39 < 1)
				&& (Lampen_P40 < 1)) {
		...
		if ((BL_OM_LN_Grundstlg_n >= 1) && (Lampen_P27 <= 0)
				&& (Lampen_P40 >= 1)) {
		...
		if ((Lampen_P27 >= 1) && (BL_OM_LN_Grundstlg_n < 1)
				&& (BL_OM_LN_belegt_n < 1) && (BL_OM_LN_Grundstlg_v < 1)
				&& (BL_OM_LN_belegt_v < 1) && (BL_OM_LN_vorgebl_n < 1)
				&& (BL_OM_LN_vorgebl_v < 1) && (Lampen_P40 <= 0)) {
		...
		if ((Lampen_P40 >= 1) && (BL_OM_LN_vorgebl_n >= 1) && (Lampen_P27 <= 0)) {
		...
		if ((BL_OM_LN_belegt_n >= 1) && (Lampen_P40 >= 1) && (Lampen_P27 <= 0)) {
		...
		if ((BL_OM_LN_Grundstlg_v >= 1) && (Lampen_P40 >= 1)
				&& (Lampen_P27 <= 0)) {
		...
		if ((Lampen_P40 >= 1) && (BL_OM_LN_vorgebl_v >= 1) && (Lampen_P27 <= 0)) {
		...
		if ((BL_OM_LN_belegt_v >= 1) && (Lampen_P40 >= 1) && (Lampen_P27 <= 0)) {
		...
		if ((BL_ZB_OM_vorgebl_v < 1) && (Lampen_P39 <= 0)
				&& (BL_ZB_OM_vorgebl_n < 1) && (BL_ZB_OM_Grundstlg_v < 1)
				&& (Lampen_P135 >= 1) && (BL_ZB_OM_belegt_v < 1)
				&& (BL_ZB_OM_Grundstlg_n < 1) && (BL_ZB_OM_belegt_n < 1)) {
		...
		if ((Lampen_P39 >= 1) && (BL_ZB_OM_vorgebl_n >= 1)
				&& (Lampen_P135 <= 0)) {
		...
		if ((Lampen_P39 >= 1) && (Lampen_P135 <= 0) && (BL_ZB_OM_belegt_n >= 1)) {
		...
		if ((Lampen_P39 >= 1) && (BL_ZB_OM_Grundstlg_v >= 1)
				&& (Lampen_P135 <= 0)) {
		...
		if ((Lampen_P39 >= 1) && (BL_ZB_OM_vorgebl_v >= 1)
				&& (Lampen_P135 <= 0)) {
		...
		if ((Lampen_P39 >= 1) && (BL_ZB_OM_belegt_v >= 1) && (Lampen_P135 <= 0)) {
		...
		if ((Lampen_Iso_cd_aus >= 1) && (Lampen_Iso_cd_ein <= 0)
				&& (Iso_cd_belegt >= 1)) {
		...
		if ((Lampen_Iso_cd_aus <= 0) && (Lampen_Iso_cd_ein >= 1)
				&& (Iso_cd_frei >= 1)) {
		...
		if ((Lampen_Iso_1_aus >= 1) && (Iso_1_belegt >= 1)
				&& (Lampen_Iso_1_ein <= 0)) {
		...
		if ((Lampen_Iso_1_ein >= 1) && (Iso_1_frei >= 1)
				&& (Lampen_Iso_1_aus <= 0)) {
		...
		if ((Iso_egf_belegt >= 1) && (Lampen_Iso_egf_aus >= 1)
				&& (Lampen_Iso_egf_ein <= 0)) {
		...
		if ((Lampen_Iso_egf_aus <= 0) && (Lampen_Iso_egf_ein >= 1)
				&& (Iso_egf_frei >= 1)) {
		...
		if ((Lampen_Iso_ef_aus >= 1) && (Iso_ef_belegt >= 1)
				&& (Lampen_Iso_ef_ein <= 0)) {
		...
		if ((Lampen_Iso_ef_aus <= 0) && (Iso_ef_frei >= 1)
				&& (Lampen_Iso_ef_ein >= 1)) {
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS_EMM_1_833 >= 1)
				&& (EMM_geprueft1A1 <= 0)) {
			if (canFire("EMM_T1")) {
				--EMM_EMM_Grundstlg;
				--ILTIS_EMM_1_833;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS_EMM_2_833 >= 1)
				&& (EMM_geprueft1A2 <= 0)) {
			if (canFire("EMM_T2")) {
				--EMM_EMM_Grundstlg;
				--ILTIS_EMM_2_833;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS_EMM_3_833 >= 1)
				&& (EMM_geprueft1A3 <= 0)) {
			if (canFire("EMM_T3")) {
				--EMM_EMM_Grundstlg;
				--ILTIS_EMM_3_833;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (EMM_geprueft1A4 <= 0)
				&& (ILTIS_EMM_4_833 >= 1)) {
			if (canFire("EMM_T4")) {
				--EMM_EMM_Grundstlg;
				++EMM_geprueft1A4;
		...
		if ((EMM_geprueft1A5 <= 0) && (ILTIS_EMM_5_833 >= 1)
				&& (EMM_EMM_Grundstlg >= 1)) {
			if (canFire("EMM_T5")) {
				++EMM_geprueft1A5;
				--ILTIS_EMM_5_833;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS_EMM_833_1 >= 1)
				&& (EMM_geprueft1E1 <= 0)) {
			if (canFire("EMM_T6")) {
				--EMM_EMM_Grundstlg;
				--ILTIS_EMM_833_1;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (EMM_geprueft1E2 <= 0)
				&& (ILTIS_EMM_833_2 >= 1)) {
			if (canFire("EMM_T7")) {
				--EMM_EMM_Grundstlg;
				++EMM_geprueft1E2;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (EMM_geprueft1E3 <= 0)
				&& (ILTIS_EMM_833_3 >= 1)) {
			if (canFire("EMM_T8")) {
				--EMM_EMM_Grundstlg;
				++EMM_geprueft1E3;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (EMM_geprueft1E4 <= 0)
				&& (ILTIS_EMM_833_4 >= 1)) {
			if (canFire("EMM_T9")) {
				--EMM_EMM_Grundstlg;
				++EMM_geprueft1E4;
		...
		if ((EMM_EMM_Grundstlg >= 1) && (ILTIS_EMM_833_5 >= 1)
				&& (EMM_geprueft1E5 <= 0)) {
			if (canFire("EMM_T10")) {
				--EMM_EMM_Grundstlg;
				--ILTIS_EMM_833_5;
		...
		if ((EMM_EMM_W7_mA1 <= 0) && (EMM_geprueft2A1 >= 1)) {
		...
		if ((EMM_EMM_W7_mA1 >= 1) && (EMM_EMM_W10_pA1 <= 0)) {
		...
		if ((EMM_geprueft1A1 >= 1) && (EMM_geprueft2A1 <= 0)
				&& (EMM_OM_E_Fahrt >= 1)) {
		...
		if ((EMM_geprueft2A2 >= 1) && (EMM_EMM_W7_pA2 <= 0)) {
		...
		if ((EMM_EMM_W7_pA2 >= 1) && (EMM_EMM_W10_pA2 <= 0)) {
		...
		if ((EMM_geprueft1A2 >= 1) && (EMM_geprueft2A2 <= 0)
				&& (EMM_OM_E_Fahrt >= 1)) {
		...
		if ((EMM_geprueft2A3 >= 1) && (EMM_EMM_W9_pA3 <= 0)) {
		...
		if ((EMM_EMM_W9_pA3 >= 1) && (EMM_EMM_W10_mA3 <= 0)) {
		...
		if ((EMM_geprueft2A3 <= 0) && (EMM_geprueft1A3 >= 1)
				&& (EMM_OM_E_Fahrt >= 1)) {
		...
		if ((EMM_geprueft2A4 >= 1) && (EMM_EMM_W8_pA4 <= 0)) {
		...
		if ((EMM_EMM_W8_pA4 >= 1) && (EMM_EMM_W9_mA4 <= 0)) {
		...
		if ((EMM_geprueft2A4 <= 0) && (EMM_geprueft1A4 >= 1)
				&& (EMM_OM_E_Fahrt >= 1)) {
		...
		if ((EMM_geprueft2A5 >= 1) && (EMM_EMM_W8_mA5 <= 0)) {
		...
		if ((EMM_EMM_W9_mA5 <= 0) && (EMM_EMM_W8_mA5 >= 1)) {
		...
		if ((EMM_geprueft1A5 >= 1) && (EMM_geprueft2A5 <= 0)
				&& (EMM_OM_E_Fahrt >= 1)) {
		...
		if ((EMM_EMM_W7_mE1 <= 0) && (EMM_geprueft1E1 >= 1)) {
		...
		if ((EMM_EMM_W7_mE1 >= 1) && (EMM_EMM_W10_pE1 <= 0)) {
		...
		if ((EMM_geprueft1E2 >= 1) && (EMM_EMM_W7_pE2 <= 0)) {
		...
		if ((EMM_EMM_W7_pE2 >= 1) && (EMM_EMM_W10_pE2 <= 0)) {
		...
		if ((EMM_EMM_W9_pE3 <= 0) && (EMM_geprueft1E3 >= 1)) {
		...
		if ((EMM_EMM_W9_pE3 >= 1) && (EMM_EMM_W10_mE3 <= 0)) {
		...
		if ((EMM_EMM_W8_pE4 <= 0) && (EMM_geprueft1E4 >= 1)) {
		...
		if ((EMM_EMM_W8_pE4 >= 1) && (EMM_EMM_W9_mE4 <= 0)) {
		...
		if ((EMM_geprueft1E5 >= 1) && (EMM_EMM_W8_mE5 <= 0)) {
		...
		if ((EMM_EMM_W9_mE5 <= 0) && (EMM_EMM_W8_mE5 >= 1)) {
		...
		if ((EMM_EMM_W10_mA5 >= 1) && (EMM_EMM_W10_mA4 >= 1)
				&& (EMM_EMM_W10_mA3 >= 1) && (EMM_EMM_W10_pE2 >= 1)
				&& (EMM_EMM_W10_mE3 >= 1) && (EMM_EMM_W10_mE4 >= 1)
				&& (EMM_EMM_W10_mE5 >= 1) && (EMM_EMM_Grundstlg <= 0)
				&& (Iso_cd_belegt >= 1) && (EMM_EMM_W10_pA1 >= 1)
				&& (EMM_EMM_W10_pE1 >= 1) && (EMM_EMM_W10_pA2 >= 1)) {
		...
		if ((EMM_EMM_W10_mA4 <= 0) && (EMM_EMM_W9_mA4 >= 1)) {
		...
		if ((EMM_EMM_W9_mA5 >= 1) && (EMM_EMM_W10_mA5 <= 0)) {
		...
		if ((EMM_EMM_W10_mE5 <= 0) && (EMM_EMM_W9_mE5 >= 1)) {
		...
		if ((EMM_EMM_W10_mE4 <= 0) && (EMM_EMM_W9_mE4 >= 1)) {
		...
		if ((EMM_C_Halt <= 0) && (EMM_C_Fahrt >= 1) && (Iso_cd_belegt >= 1)) {
			if (canFire("EMM_T25")) {
				++EMM_C_Halt;
				--EMM_C_Fahrt;
				--Iso_cd_belegt;
		...
		if ((EMM_C_FB2 <= 0) && (EMM_C_Fahrt >= 1) && (EMM_EMM_W10_pA1 >= 1)
				&& (EMM_EMM_W10_mA3 >= 1) && (EMM_EMM_W10_mA5 >= 1)
				&& (EMM_EMM_W10_mA4 >= 1)) {
			if (canFire("EMM_TC2")) {
				++EMM_C_FB2;
				--EMM_C_Fahrt;
		...
		if ((EMM_C_FB1 <= 0) && (EMM_C_Fahrt >= 1) && (EMM_EMM_W10_pA2 >= 1)) {
			if (canFire("EMM_TC1")) {
				++EMM_C_FB1;
				--EMM_C_Fahrt;
				--EMM_EMM_W10_pA2;
		...
		if ((EMM_C_Halt >= 1) && (EMM_C_Fahrt <= 0) && (EMM_EMM_W10_pA1 >= 1)
				&& (EMM_EMM_W10_mA3 >= 1) && (EMM_EMM_W10_mA4 >= 1)
				&& (EMM_EMM_W10_mA5 >= 1) && (EMM_EMM_W10_pA2 >= 1)) {
			if (canFire("EMM_T24")) {
				--EMM_C_Halt;
				++EMM_C_Fahrt;
				--EMM_EMM_W10_pA1;
		...
		if ((EMM_D_Fahrt >= 1) && (EMM_D_Halt <= 0) && (Iso_cd_belegt >= 1)) {
			if (canFire("EMM_T125")) {
				--EMM_D_Fahrt;
				++EMM_D_Halt;
				--Iso_cd_belegt;
		...
		if ((EMM_D_Fahrt >= 1) && (EMM_D_FB2 <= 0) && (EMM_EMM_W10_pE1 >= 1)
				&& (EMM_EMM_W10_mE5 >= 1) && (EMM_EMM_W10_mE4 >= 1)
				&& (EMM_EMM_W10_mE3 >= 1)) {
			if (canFire("EMM_TD2")) {
				--EMM_D_Fahrt;
				++EMM_D_FB2;
		...
		if ((EMM_D_Fahrt >= 1) && (EMM_D_FB1 <= 0) && (EMM_EMM_W10_pE2 >= 1)) {
			if (canFire("EMM_TD1")) {
				--EMM_D_Fahrt;
				++EMM_D_FB1;
				--EMM_EMM_W10_pE2;
		...
		if ((EMM_D_Halt >= 1) && (EMM_D_Fahrt <= 0) && (EMM_EMM_W10_pE2 >= 1)
				&& (EMM_EMM_W10_mE3 >= 1) && (EMM_EMM_W10_mE4 >= 1)
				&& (EMM_EMM_W10_mE5 >= 1) && (EMM_EMM_W10_pE1 >= 1)) {
			if (canFire("EMM_T124")) {
				--EMM_D_Halt;
				++EMM_D_Fahrt;
				--EMM_EMM_W10_pE2;
		...
		if ((LN_geprueft1A5 >= 1) && (BL_OM_LN_Grundstlg_v >= 1)
				&& (LN_geprueft2A5 <= 0)) {
		...
		if ((ILTIS_LN_834_2 >= 1) && (LN_EMM_Grundstlg >= 1)
				&& (LN_geprueft1E2 <= 0)) {
			if (canFire("LN_T7")) {
				--ILTIS_LN_834_2;
				--LN_EMM_Grundstlg;
		...
		if ((ILTIS_LN_1_834 >= 1) && (LN_geprueft1A1 <= 0)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T1")) {
				--ILTIS_LN_1_834;
				++LN_geprueft1A1;
		...
		if ((BL_OM_LN_Grundstlg_v >= 1) && (LN_geprueft1A4 >= 1)
				&& (LN_geprueft2A4 <= 0)) {
		...
		if ((ILTIS_LN_5_834 >= 1) && (LN_geprueft1A5 <= 0)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T5")) {
				--ILTIS_LN_5_834;
				++LN_geprueft1A5;
		...
		if ((LN_LN_W1_pA2 >= 1) && (LN_LN_W2_pA2 <= 0)) {
		...
		if ((LN_geprueft1A4 <= 0) && (ILTIS_LN_4_834 >= 1)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T4")) {
				++LN_geprueft1A4;
				--ILTIS_LN_4_834;
		...
		if ((BL_OM_LN_Grundstlg_v >= 1) && (LN_geprueft1A1 >= 1)
				&& (LN_geprueft2A1 <= 0)) {
		...
		if ((LN_geprueft2A3 >= 1) && (LN_LN_W1_pA3 <= 0)) {
		...
		if ((LN_geprueft2A3 <= 0) && (LN_geprueft1A3 >= 1)
				&& (BL_OM_LN_Grundstlg_v >= 1)) {
		...
		if ((LN_LN_W1_mA1 <= 0) && (LN_geprueft2A1 >= 1)) {
		...
		if ((LN_EMM_Grundstlg >= 1) && (LN_geprueft1E4 <= 0)
				&& (ILTIS_LN_834_4 >= 1)) {
			if (canFire("LN_T9")) {
				--LN_EMM_Grundstlg;
				++LN_geprueft1E4;
		...
		if ((LN_LN_W6_mA6 >= 1) && (LN_EMM_Grundstlg <= 0)
				&& (LN_ce_belegt >= 1) && (LN_LN_W1_mA1 >= 1)
				&& (LN_LN_W2_pA2 >= 1) && (LN_LN_W5_pA3 >= 1)
				&& (LN_LN_W5_mA4 >= 1) && (LN_LN_W6_mA5 >= 1)
				&& (LN_LN_W6_mE5 >= 1) && (LN_LN_W6_mE6 >= 1)
				&& (LN_LN_W5_mE4 >= 1) && (LN_LN_W5_pE3 >= 1)
				&& (LN_LN_W2_pE2 >= 1) && (LN_LN_W1_mE1 >= 1)) {
		...
		if ((LN_EMM_Grundstlg >= 1) && (ILTIS_LN_834_1 >= 1)
				&& (LN_geprueft1E1 <= 0)) {
			if (canFire("LN_T6")) {
				--LN_EMM_Grundstlg;
				--ILTIS_LN_834_1;
		...
		if ((LN_EMM_Grundstlg >= 1) && (LN_geprueft1E3 <= 0)
				&& (ILTIS_LN_834_3 >= 1)) {
			if (canFire("LN_T8")) {
				--LN_EMM_Grundstlg;
				++LN_geprueft1E3;
		...
		if ((LN_EMM_Grundstlg >= 1) && (ILTIS_LN_834_5 >= 1)
				&& (LN_geprueft1E5 <= 0)) {
			if (canFire("LN_T10")) {
				--LN_EMM_Grundstlg;
				--ILTIS_LN_834_5;
		...
		if ((LN_LN_W1_pA2 <= 0) && (LN_geprueft2A2 >= 1)) {
		...
		if ((BL_OM_LN_Grundstlg_v >= 1) && (LN_geprueft1A2 >= 1)
				&& (LN_geprueft2A2 <= 0)) {
		...
		if ((ILTIS_LN_2_834 >= 1) && (LN_geprueft1A2 <= 0)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T2")) {
				--ILTIS_LN_2_834;
				++LN_geprueft1A2;
		...
		if ((LN_geprueft1A3 <= 0) && (ILTIS_LN_3_834 >= 1)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T3")) {
				++LN_geprueft1A3;
				--ILTIS_LN_3_834;
		...
		if ((LN_LN_W1_pA3 >= 1) && (LN_LN_W2_mA3 <= 0)) {
		...
		if ((LN_LN_W2_mA3 >= 1) && (LN_LN_W3_pA3 <= 0)) {
		...
		if ((LN_LN_W3_pA4 <= 0) && (LN_LN_W2_mA4 >= 1)) {
		...
		if ((LN_LN_W1_pA4 <= 0) && (LN_geprueft2A4 >= 1)) {
		...
		if ((LN_LN_W1_pA4 >= 1) && (LN_LN_W2_mA4 <= 0)) {
		...
		if ((LN_LN_W5_pA3 <= 0) && (LN_LN_W3_pA3 >= 1)) {
		...
		if ((LN_LN_W5_mA4 <= 0) && (LN_LN_W3_pA4 >= 1)) {
		...
		if ((LN_LN_W2_mA5 <= 0) && (LN_LN_W1_pA5 >= 1)) {
		...
		if ((LN_LN_W2_mA5 >= 1) && (LN_LN_W3_mA5 <= 0)) {
		...
		if ((LN_LN_W1_pA5 <= 0) && (LN_geprueft2A5 >= 1)) {
		...
		if ((LN_LN_W3_mA5 >= 1) && (LN_LN_W4_pA5 <= 0)) {
		...
		if ((LN_LN_W4_pA5 >= 1) && (LN_LN_W6_mA5 <= 0)) {
		...
		if ((LN_LN_W1_pA6 >= 1) && (LN_LN_W2_mA6 <= 0)) {
		...
		if ((LN_LN_W4_pA6 >= 1) && (LN_LN_W6_mA6 <= 0)) {
		...
		if ((LN_LN_W4_pA6 <= 0) && (LN_LN_W3_mA6 >= 1)) {
		...
		if ((LN_geprueft2A6 >= 1) && (LN_LN_W1_pA6 <= 0)) {
		...
		if ((LN_LN_W2_mA6 >= 1) && (LN_LN_W3_mA6 <= 0)) {
		...
		if ((LN_geprueft1A6 >= 1) && (LN_geprueft2A6 <= 0)
				&& (BL_OM_LN_Grundstlg_v >= 1)) {
		...
		if ((ILTIS_LN_6_834 >= 1) && (LN_geprueft1A6 <= 0)
				&& (LN_EMM_Grundstlg >= 1)) {
			if (canFire("LN_T105")) {
				--ILTIS_LN_6_834;
				++LN_geprueft1A6;
		...
		if ((LN_LN_W1_pE6 >= 1) && (LN_LN_W2_mE6 <= 0)) {
		...
		if ((LN_LN_W3_pE4 <= 0) && (LN_LN_W2_mE4 >= 1)) {
		...
		if ((LN_geprueft1E1 >= 1) && (LN_LN_W1_mE1 <= 0)) {
		...
		if ((LN_geprueft1E6 >= 1) && (LN_LN_W1_pE6 <= 0)) {
		...
		if ((LN_LN_W3_mE6 <= 0) && (LN_LN_W2_mE6 >= 1)) {
		...
		if ((LN_LN_W6_mE6 <= 0) && (LN_LN_W4_pE6 >= 1)) {
		...
		if ((LN_LN_W2_mE3 >= 1) && (LN_LN_W3_pE3 <= 0)) {
		...
		if ((LN_LN_W3_mE6 >= 1) && (LN_LN_W4_pE6 <= 0)) {
		...
		if ((LN_LN_W1_pE4 >= 1) && (LN_LN_W2_mE4 <= 0)) {
		...
		if ((LN_geprueft1E3 >= 1) && (LN_LN_W1_pE3 <= 0)) {
		...
		if ((LN_geprueft1E2 >= 1) && (LN_LN_W1_pE2 <= 0)) {
		...
		if ((LN_LN_W2_mE5 >= 1) && (LN_LN_W3_mE5 <= 0)) {
		...
		if ((LN_LN_W2_mE3 <= 0) && (LN_LN_W1_pE3 >= 1)) {
		...
		if ((LN_LN_W1_pE5 <= 0) && (LN_geprueft1E5 >= 1)) {
		...
		if ((LN_LN_W6_mE5 <= 0) && (LN_LN_W4_pE5 >= 1)) {
		...
		if ((LN_LN_W4_pE5 <= 0) && (LN_LN_W3_mE5 >= 1)) {
		...
		if ((LN_LN_W1_pE4 <= 0) && (LN_geprueft1E4 >= 1)) {
		...
		if ((LN_LN_W5_mE4 <= 0) && (LN_LN_W3_pE4 >= 1)) {
		...
		if ((LN_LN_W2_pE2 <= 0) && (LN_LN_W1_pE2 >= 1)) {
		...
		if ((LN_LN_W5_pE3 <= 0) && (LN_LN_W3_pE3 >= 1)) {
		...
		if ((LN_LN_W2_mE5 <= 0) && (LN_LN_W1_pE5 >= 1)) {
		...
		if ((LN_EMM_Grundstlg >= 1) && (LN_geprueft1E6 <= 0)
				&& (ILTIS_LN_834_6 >= 1)) {
			if (canFire("LN_T110")) {
				--LN_EMM_Grundstlg;
				++LN_geprueft1E6;
		...
		if ((LN_C1_Halt <= 0) && (LN_C1_Fahrt2 >= 1) && (LN_ce_belegt >= 1)) {
			if (canFire("LN_T125")) {
				++LN_C1_Halt;
				--LN_C1_Fahrt2;
				--LN_ce_belegt;
		...
		if ((LN_C1_Halt >= 1) && (LN_C1_Fahrt2 <= 0) && (LN_LN_W1_mA1 >= 1)) {
			if (canFire("LN_T124")) {
				--LN_C1_Halt;
				++LN_C1_Fahrt2;
				--LN_LN_W1_mA1;
		...
		if ((LN_C26_Fahrt >= 1) && (LN_C26_Halt <= 0) && (LN_ce_belegt >= 1)) {
			if (canFire("LN_T225")) {
				--LN_C26_Fahrt;
				++LN_C26_Halt;
				--LN_ce_belegt;
		...
		if ((LN_C26_Fahrt >= 1) && (LN_C26_FB2 <= 0) && (LN_LN_W6_mA6 >= 1)
				&& (LN_LN_W6_mA5 >= 1) && (LN_LN_W5_mA4 >= 1)
				&& (LN_LN_W5_pA3 >= 1)) {
			if (canFire("LN_TC2")) {
				--LN_C26_Fahrt;
				++LN_C26_FB2;
		...
		if ((LN_C26_Fahrt >= 1) && (LN_C26_FB1 <= 0) && (LN_LN_W2_pA2 >= 1)) {
			if (canFire("LN_TC1")) {
				--LN_C26_Fahrt;
				++LN_C26_FB1;
				--LN_LN_W2_pA2;
		...
		if ((LN_C26_Halt >= 1) && (LN_C26_Fahrt <= 0) && (LN_LN_W2_pA2 >= 1)
				&& (LN_LN_W5_pA3 >= 1) && (LN_LN_W5_mA4 >= 1)
				&& (LN_LN_W6_mA5 >= 1) && (LN_LN_W6_mA6 >= 1)) {
			if (canFire("LN_T224")) {
				--LN_C26_Halt;
				++LN_C26_Fahrt;
				--LN_LN_W2_pA2;
		...
		if ((LN_E_Fahrt >= 1) && (LN_E_FB2 <= 0) && (LN_LN_W6_mE6 >= 1)
				&& (LN_LN_W6_mE5 >= 1) && (LN_LN_W5_mE4 >= 1)
				&& (LN_LN_W5_pE3 >= 1) && (LN_LN_W1_mE1 >= 1)) {
			if (canFire("LN_TD2")) {
				--LN_E_Fahrt;
				++LN_E_FB2;
				--LN_LN_W6_mE6;
		...
		if ((LN_E_Fahrt >= 1) && (LN_E_FB1 <= 0) && (LN_LN_W2_pE2 >= 1)) {
			if (canFire("LN_TD1")) {
				--LN_E_Fahrt;
				++LN_E_FB1;
				--LN_LN_W2_pE2;
		...
		if ((LN_e_Halt >= 1) && (LN_E_Fahrt <= 0) && (LN_LN_W1_mE1 >= 1)
				&& (LN_LN_W2_pE2 >= 1) && (LN_LN_W6_mE5 >= 1)
				&& (LN_LN_W5_pE3 >= 1) && (LN_LN_W6_mE6 >= 1)
				&& (LN_LN_W5_mE4 >= 1)) {
			if (canFire("LN_T324")) {
				--LN_e_Halt;
				++LN_E_Fahrt;
		...
		if ((ILTIS_ZB_138_2 >= 1) && (ZB_geprueft1E2 <= 0)
				&& (ZB_EMM_Grundstlg >= 1)) {
			if (canFire("ZB_T7")) {
				--ILTIS_ZB_138_2;
				++ZB_geprueft1E2;
		...
		if ((ZB_D_Halt <= 0) && (ZB_D_Fahrt >= 1) && (ZB_cd_belegt >= 1)) {
			if (canFire("ZB_T225")) {
				++ZB_D_Halt;
				--ZB_D_Fahrt;
				--ZB_cd_belegt;
		...
		if ((ILTIS_ZB_1_138 >= 1) && (ZB_geprueft1A1 <= 0)
				&& (ZB_EMM_Grundstlg >= 1)) {
			if (canFire("ZB_T1")) {
				--ILTIS_ZB_1_138;
				++ZB_geprueft1A1;
		...
		if ((ZB_ZB_W2_pE2 <= 0) && (ZB_geprueft1E2 >= 1)) {
		...
		if ((BL_ZB_OM_Grundstlg_v >= 1) && (ZB_geprueft1A1 >= 1)
				&& (ZB_geprueft2A1 <= 0)) {
		...
		if ((ZB_ZB_W2_mA1 <= 0) && (ZB_geprueft2A1 >= 1)) {
		...
		if ((ZB_ZB_W1_pE2 >= 1) && (ZB_ZB_W1_mE1 >= 1)
				&& (ZB_EMM_Grundstlg <= 0) && (ZB_ZB_W1_pA2 >= 1)
				&& (ZB_ZB_W1_mA1 >= 1) && (ZB_cd_belegt >= 1)) {
		...
		if ((ZB_ZB_W2_mE1 <= 0) && (ZB_geprueft1E1 >= 1)) {
		...
		if ((ZB_C_Halt <= 0) && (ZB_cd_belegt >= 1) && (ZB_C_Fahrt >= 1)) {
			if (canFire("ZB_T125")) {
				++ZB_C_Halt;
				--ZB_cd_belegt;
				--ZB_C_Fahrt;
		...
		if ((ILTIS_ZB_138_1 >= 1) && (ZB_geprueft1E1 <= 0)
				&& (ZB_EMM_Grundstlg >= 1)) {
			if (canFire("ZB_T6")) {
				--ILTIS_ZB_138_1;
				++ZB_geprueft1E1;
		...
		if ((ZB_ZB_W2_pA2 <= 0) && (ZB_geprueft2A2 >= 1)) {
		...
		if ((BL_ZB_OM_Grundstlg_v >= 1) && (ZB_geprueft1A2 >= 1)
				&& (ZB_geprueft2A2 <= 0)) {
		...
		if ((ILTIS_ZB_2_138 >= 1) && (ZB_geprueft1A2 <= 0)
				&& (ZB_EMM_Grundstlg >= 1)) {
			if (canFire("ZB_T2")) {
				--ILTIS_ZB_2_138;
				++ZB_geprueft1A2;
		...
		if ((ZB_D_Halt >= 1) && (ZB_ZB_W1_mE1 >= 1) && (ZB_ZB_W1_pE2 >= 1)
				&& (ZB_D_Fahrt <= 0)) {
			if (canFire("ZB_T224")) {
				--ZB_D_Halt;
				--ZB_ZB_W1_mE1;
		...
		if ((ZB_C_Halt >= 1) && (ZB_ZB_W1_mA1 >= 1) && (ZB_ZB_W1_pA2 >= 1)
				&& (ZB_C_Fahrt <= 0)) {
			if (canFire("ZB_T124")) {
				--ZB_C_Halt;
				--ZB_ZB_W1_mA1;
		...
		if ((ZB_ZB_W1_pE2 <= 0) && (ZB_ZB_W2_pE2 >= 1)) {
		...
		if ((ZB_ZB_W1_mE1 <= 0) && (ZB_ZB_W2_mE1 >= 1)) {
		...
		if ((ZB_ZB_W1_pA2 <= 0) && (ZB_ZB_W2_pA2 >= 1)) {
		...
		if ((ZB_ZB_W2_mA1 >= 1) && (ZB_ZB_W1_mA1 <= 0)) {
		...
		if ((ZB_C_Fahrt >= 1) && (ZB_C_FB1 <= 0) && (ZB_ZB_W1_pA2 >= 1)) {
			if (canFire("ZB_TC1")) {
				--ZB_C_Fahrt;
				++ZB_C_FB1;
				--ZB_ZB_W1_pA2;
		...
		if ((ZB_C_FB2 <= 0) && (ZB_C_Fahrt >= 1) && (ZB_ZB_W1_mA1 >= 1)) {
			if (canFire("ZB_TC2")) {
				++ZB_C_FB2;
				--ZB_C_Fahrt;
				--ZB_ZB_W1_mA1;
		...
		if ((ZB_D_Fahrt >= 1) && (ZB_D_FB1 <= 0) && (ZB_ZB_W1_pE2 >= 1)) {
			if (canFire("ZB_TD3")) {
				--ZB_D_Fahrt;
				++ZB_D_FB1;
				--ZB_ZB_W1_pE2;
		...
		if ((ZB_D_Fahrt >= 1) && (ZB_D_FB2 <= 0) && (ZB_ZB_W1_mE1 >= 1)) {
			if (canFire("ZB_TD4")) {
				--ZB_D_Fahrt;
				++ZB_D_FB2;
				--ZB_ZB_W1_mE1;
		...
		if ((ILTIS_festgehalten_vLN >= 1) && (ILTIS_freigegeben_vLN <= 0)
		...
		if ((ILTIS_festgehalten_vLN <= 0) && (ILTIS_freigegeben_vLN >= 1)
		...
		if ((ILTIS_freigegeben_vZB <= 0) && (ILTIS_freigeben_vZB >= 1)
		...
		if ((ILTIS_freigegeben_vZB >= 1) && (ILTIS_festgehalten_v_ZB <= 0)
		...
		if ((ILTIS_RM_moeglich2 <= 0) && (ILTIS_P230 >= 1)) {
		...
		if ((ILTIS_RM_moeglich2 >= 1) && (ILTIS_P230 <= 0)) {
		...
		if ((ILTIS_RM_moeglich2 >= 1) && (ILTIS_rueckmelden_LN_OM >= 1)
				&& (ILTIS_RM_LN_OM <= 0)) {
		...
		if ((ILTIS_RM_moeglich1 <= 0) && (ILTIS_P130 >= 1)) {
		...
		if ((ILTIS_RM_moeglich1 >= 1) && (ILTIS_P130 <= 0)) {
		...
		if ((ILTIS_RM_moeglich1 >= 1) && (ILTIS_RM_ZB_OM <= 0)
