...
import ch.desm.middleware.module.desm.simulation.zusi.map.ZusiMapParameterRe420;
import ch.desm.middleware.module.desm.simulation.zusi.message.ZusiMessageEndpoint;
