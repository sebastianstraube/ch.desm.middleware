...
import ch.desm.middleware.app.core.component.petrinet.obermattlangnau.map.PetrinetMapInterlockingOml;
...
public class PetrinetOmlService {
    ...
    private PetrinetMapInterlockingOml map;
    ...
    public PetrinetOmlService(Broker broker){
        ...
        this.map = new PetrinetMapInterlockingOml();
    ...
    public PetrinetMapInterlockingOml getMap(){
        return this.map;
    }
