...
public class JettyServer extends Thread {
    ...
    public JettyServer(String projectDir, String warDeploymentName, String warModuleName, int listenPort, String listenIp){
        this.inetSocketAddress = new InetSocketAddress(listenIp, listenPort);
        targetDir = File.separator+warModuleName+File.separator+"target"+File.separator+warDeploymentName;
