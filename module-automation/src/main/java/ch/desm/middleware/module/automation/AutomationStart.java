...
public class AutomationStart {
    ...
    private static Logger LOGGER = Logger.getLogger(AutomationStart.class);

    public static void main(String[] args) {
        LOGGER.log(Level.INFO, "initialise middleware...");
        LOGGER.log(Level.INFO, "starting directory: " + System.getProperty("user.dir"));

        final AutomationMiddlewareConfig config = new AutomationMiddlewareConfig();
        ...
        final AutomationMiddleware middleware = new AutomationMiddleware(config);
