...
public class AutomationModuleStart {

    private static Logger LOGGER = Logger.getLogger(AutomationModuleStart.class);
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0 && args.length <= 4) {
            ...
            LOGGER.log(Level.INFO, "start input arguments not computed!");
            /*
        ...
        final AutomationModuleService middleware = new AutomationModuleService(config);
